(function( $ , api){
    ...
    api.section( 'bizcon_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'bizcon_about_section' , function( section ){
    ...
    api.section( 'bizcon_blog_section' , function( section ){
    ...
    api.section( 'bizcon_portfolio_section' , function( section ){
    ...
    api.section( 'bizcon_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-bizcon_contact_custom_formshortcode'),
                selector = $('#_customize-input-bizcon_contact_formshortcode');
    ...
    // General section
    api.section( 'bizcon_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#bizcon_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-bizcon_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-bizcon_preloader_color' );
            ...
            var $backtotop          = $( '#bizcon_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-bizcon_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-bizcon_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'bizcon_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#bizcon_footer_widget_toggle');
