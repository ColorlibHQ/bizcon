...
// image default alt
if( !function_exists( 'bizcon_img_default_alt' ) ){
	function bizcon_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'bizcon_img_tag' ) ){
	function bizcon_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = bizcon_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'bizcon_anchor_tag' ) ){
	function bizcon_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'bizcon_heading_tag' ) ){
	function bizcon_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'bizcon_paragraph_tag' ) ){
	function bizcon_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'bizcon_other_tag' ) ){
	function bizcon_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'bizcon_button_element ' ) ){
	function bizcon_button_element( array $args ){
