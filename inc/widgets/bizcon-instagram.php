...
----------------------------------------*/
class bizcon_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('bizcon_instagram_photo',esc_html__('[ Bizcon ] Intagram Photo','bizcon'),array(
			'description' => esc_html__('Bizcon Instagram Photo Widget','bizcon'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'bizcon');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'bizcon'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'bizcon'); ?></label>
...
if(!function_exists('bizcon_instagram_widgets')):
	function bizcon_instagram_widgets(){
		register_widget('bizcon_instagram_photo');
	}
	add_action('widgets_init','bizcon_instagram_widgets');
endif;
