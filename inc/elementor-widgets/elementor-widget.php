    ...
    final class Bizcon_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'bizcon-map-custom', BIZCON_DIR_ELEMENTOR . 'assets/js/map-custom.js', array(), '1.0-s2', true );

            // bizcon companion main js
            wp_enqueue_script( 'bizcon', BIZCON_DIR_ELEMENTOR . 'assets/js/bizcon-companion-main.js', array( 'bizcon-ui-js' ), '1.0-s2', true );
